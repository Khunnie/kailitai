...
//    else {
//        var sid = request("sid");
//        location.href = "/" + (sid != null ? sid + "/" : "");
//    }
//}
function request(val) {
    var url = window.location.seach;
    var urlPa = null;
    alert(url);
    if (typeof url != "undefined") {
        var re = new RegExp("" + val + "\=([^\&\?]*)", "ig");
        if (url.match(re))
            urlPa = url.match(re)[0].substr(val.length + 1);
    }
    return urlPa;
}
...
function tel(tit,telnum) {
    ...
    var itel = $("<div class='itel'></div>");
    
	var li = $("<div>点击拨打<a href='tel:" + telnum + "'><p>" + telnum + "</p></a></div>");
	itel.append(li);
	
    var submit = $("<div class='submit'><input type='button' class='cancel' value='取消' style='width: 100%; margin: 0;'></div>");
    windowContent.append(itel);
    ...
    detailtel.appendTo(".global:visible");
    detailtel.show();
}
